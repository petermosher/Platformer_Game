...
function LateUpdate()
{
	...
	{
        //starting position
		transform.position = startPosition; //Vector3(-58.33616, 20.30083, -0.4077807);
...
function UpdateSmoothedMovementDirection () {	
	...
	if (controller.isGrounded) {
		...
		if (movement.isMoving)
			movement.inAirVelocity += Vector3 (Mathf.Sign(h), 0, 0) * Time.deltaTime * movement.inAirControlAcceleration * -12;
	}
}
